...
namespace jjm.one.MiscUtilClasses.Utilities
{
    ...
    public static class Guard
    {
        ...
        /// <summary>
        /// Throws <see cref="ArgumentOutOfRangeException"/> if <paramref name="value"/> is not strictly positive (i.e., &lt;= 0).
        /// </summary>
        /// <param name="value">The value to check.</param>
        /// <param name="paramName">The parameter name used in the exception message.</param>
        ...
        /// <summary>
        /// Throws <see cref="ArgumentOutOfRangeException"/> if <paramref name="value"/> lies outside [<paramref name="min"/>, <paramref name="max"/>].
        /// </summary>
        /// <param name="value">The value to check.</param>
