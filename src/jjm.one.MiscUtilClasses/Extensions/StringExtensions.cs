...
namespace jjm.one.MiscUtilClasses.Extensions
{
    ...
    public static class StringExtensions
    {
        ...
        /// <returns>The original string when it is not longer than <paramref name="maxLength"/>;
        /// otherwise the first <paramref name="maxLength"/> characters.</returns>
        ...
        /// <exception cref="ArgumentNullException">Thrown when <paramref name="value"/> or <paramref name="candidates"/> is null.</exception>
